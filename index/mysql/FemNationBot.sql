...
INSERT INTO QnA (Questions,Answer)
    ...
    ('What is gender bias?', 'Gender bias is prejudice or discrimination based on a person’s gender, often unconscious but harmful in many settings.'),
    ('Can feminism be misunderstood?', 'Yes, sometimes feminism is misrepresented; it’s about equality, not about one gender being superior to another.'),
